...
def Channel_Attribution():
    ...
    with heatmap:
        ...
        st.markdown("""<p style="color:#00568D; padding:5px 15px; font-family:'Segoe UI'; font-size:20px;"><b>Channel Atrribution Matrix Heat Map</b></p>
                    """, True)
...
#             npc_df['EVENT_FORM']=npc_df['EVENT_FORM'].astype(str)+"%"
    ...
    with tables:
        ...
        with col1:
            ...
            pd_df_bestpath['probability'] = pd_df_bestpath['probability'].replace(['0.35'], '35%')
        ...
        with col2:
            ...
            pd_df_leastpath['probability'] = pd_df_leastpath['probability'].replace(['0.0500'], '9%')
            pd_df_leastpath['probability'] = pd_df_leastpath['probability'].replace(['0.0700'], '16%')
